  ...
  return (
    <>
      ...
      <div className="mx-auto min-h-screen max-w-5xl px-4 py-8 sm:px-8">
        {/* Header */}
        <div className="mb-8">
          <p className="font-mono text-xs uppercase tracking-[0.3em] text-brass/70">Analytics</p>
          <h1 className="mt-2 font-display text-3xl font-semibold">Statistics</h1>
          <p className="mt-2 text-sm text-paper/50">
            Insights into how your content is performing.
          </p>
        </div>
        ...
        {/* Two columns: Top items + Trending */}
        ...
        {/* Three columns: Reactions + Content pie + Categories */}
        ...
        <div className="mb-8 rounded-xl border border-brass/15 bg-gradient-to-r from-brass/5 to-transparent p-4 sm:p-6">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <FactCard
              ...
              detail={data.funFacts.busiestDay?.date || 'No data yet'}
            />
            <FactCard
              emoji="📊"
            ...
            <FactCard
              ...
              value={data.funFacts.mostActiveDay}
              detail="Day of the week"
            />
          </div>
        </div>
      </div>
